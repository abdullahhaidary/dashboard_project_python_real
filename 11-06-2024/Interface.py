...
class Interface:
    ...
    def init_camera(self,url):
        print(f'the init shit is called with {url}')
        if self.capture_process and self.capture_process.is_alive():
    ...
    def update_ui(self): 
        ...
        if self.shared_memory:
            try:
                ...
                frame = np.frombuffer(frame_bytes, dtype=np.uint8).reshape(self.shape)
        ...
        self.left_frame.after(50, self.update_ui)  # Adjusted to 50ms
    ...
    def create_left_frame(self):
        ...
        self.change_camera('C:\\Users\\PC\\PycharmProjects\\UserInterface\\dashboard\\video.mp4')
